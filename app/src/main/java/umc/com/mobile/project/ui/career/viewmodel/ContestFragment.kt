...
class ContestFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val contests = arrayListOf(
            ContestDto("2022-01-01", "공모전1", "10pt", "상 이름1"),
            ContestDto("2022-02-15", "공모전2", "10pt", "상 이름1"),
            ContestDto("2022-03-30", "공모전3", "10pt", "상 이름1"),
            ContestDto("2022-02-15", "공모전4", "10pt", "상 이름1"),
            ContestDto("2022-03-30", "공모전5", "10pt", "상 이름1")
        )
